let stringify=item=>{
	...
	if(typeof item=="object"||typeof item=="symbol")return"Object.assign(new "+item.constructor.name+",{"+[...Object.keys(item),...Object.getOwnPropertyNames(item.constructor.prototype)].map(key=>"\""+key+"\":"+stringify(item[key])).join(",")+"})";
