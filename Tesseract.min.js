					...
					var k = function(t, e) {
					  ...
					  , P = function(t) {
						 ...
						 return new Promise((function(t, i) {
							  d("[".concat(e, "]: Start ").concat(r, ", action=").concat(n)),
							  k(n, t),
							  _(n, i),
							  E(S, {
									workerId: e,
		 ...
		 549: t=>{
			  ...
			  t.exports = function(t) {
					var e = []
					  ...
					  , i = []
					  , a = [];
					return t.blocks.forEach((function(c) {
					}
					)),
					r(r({}, t), {}, {
					})
